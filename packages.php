...
<div class="page text-center">
    ...
    <header class="page-head slider-menu-position">
        ...
        <section
            ...
            data-parallax-img= "images/backgrounds/2.jpg">
            ...
            <div class="parallax-content" style="background: rgba(000,000,000,0.2);">
                <div class="shell section-30 section-md-top-125 section-lg-top-210">
                    <div class="veil reveal-md-block">
                        <h1 class="text-bold">Packages</h1>
                    </div>
                    <ul class="list-inline list-inline-icon list-inline-icon-type-1 list-inline-icon-extra-small list-inline-icon-white p offset-md-top-30 offset-md-top-40 offset-lg-top-125">
                        ...
                        <li><a class="text-white" href="packages.php"  >Packages</a></li>
                ...
                <div class="range range-xs-center">
                    <div class="cell-md-8">
                        ...
                        <div class="offset-top-30 offset-md-top-60">
                            <p>JAIS International (Pvt) Ltd. Travel Agent & Tour operator  offers a real variety of traveling destinations, whatever your initial
                                objective is. We Offers many International & Domestic Tour Packages in a resonable price with good services</p>
                        </div>
                        <div class="range range-xs-center offset-top-30 offset-md-top-60">
                                ...
                                <div class="cell-xs-10 cell-sm-6">
                                    ...
                                    <div class="box-member box-member-type-2 box-member-modern box-member-caption-offset">
                                        <div class="box-member-img-wrap"><img class="img-responsive" style="width: 500px;height: 370px"
                                                                              src="images/jais_image/package/<?php echo $all_category['s_product_name']?>/<?php echo $all_category['s_product_image']?>"
                                                                              alt=""/></div>
                                                ...
                                                <div class="box-member-caption-inner">
                                                    <div class="box-member-caption-wrap">
                                                        <div class="box-member-title">
                                                            <div class="h4 text-bold text-white"><a href="package_detail.php?id=<?php echo $all_category['s_product_name']?>"><?php echo $all_category['s_product_name']?></a></div>
                                                        </div>
                                                        <div class="box-member-description offset-top-6">
                                                            <p></p>
                                                        </div>
                                                        <div class="offset-top-20"><a class="btn btn-primary-inverse"
                                                                                      href="package_detail.php?id=<?php echo $all_category['s_product_name']?>">GET DETAILS</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            while ($rowcount < 2 && $all_category = $result->fetch_array()) {
                                ...
                                <div class="cell-xs-10 cell-sm-6 offset-top-30 offset-sm-top-0">
                                    ...
                                    <div class="box-member box-member-type-2 box-member-modern box-member-caption-offset">
                                        <div class="box-member-img-wrap"><img class="img-responsive" style="width: 500px;height: 370px"
                                                                              src="images/jais_image/package/<?php echo $all_category['s_product_name']?>/<?php echo $all_category['s_product_image']?>" alt="" /></div>
                                        <div class="box-member-wrap">
                                            <div class="box-member-caption">
                                                <div class="box-member-caption-inner">
                                                    <div class="box-member-caption-wrap">
