            ...
            <div class="parallax-content">
                <div class="shell section-30 section-md-top-125 section-lg-top-210">
                    <div class="veil reveal-md-block">
                        <h1 class="text-bold" style="font-size: 43px">Hotel Details</h1>
                    </div>
                    <ul class="list-inline list-inline-icon list-inline-icon-type-1 list-inline-icon-extra-small list-inline-icon-white p offset-md-top-30 offset-md-top-40 offset-lg-top-125">
                        ...
                        <li><a class="text-white" href="hotels.php"  >Hotel Details</a></li>
        ...
        <section class="section-90 section-md-111 text-left">
            <div class="shell">
                <div class="range range-xs-center">
                    <div class="cell-md-8">
                        <h2 class="text-bold text-center text-md-left">Hotel DETAILS</h2>
                                ...
                                <div class="cell-xs-10 cell-sm-6">
                                    ...
                                    <div class="box-member box-member-type-2 box-member-modern box-member-caption-offset">
                                        ...
                                        <div class="box-member-img-wrap"><img class="img-responsive" style="width: 500px;height: 370px"
                                                                              src="images/jais_image/hotel/<?php echo $all_category['hotel_name']?>/<?php echo $all_category['s_product_image']?>"
                                                                              alt=""/></div>
                                                ...
                                                <div class="box-member-caption-inner">
                                                    <div class="box-member-caption-wrap">
                                                        <div class="box-member-title">
                                                            <div class="h4 text-bold text-white"><a href=""><?php echo $all_category['hotel_name']?></a></div>
                                                        </div>
                                                        ...
                                                        <div class="offset-top-20">
                                                            ...
                                                            <p style="display: none" class="3"><?php echo $all_category['hotel_name']; ?></p>
                                                            <p style="display: none" class="1"><?php echo $all_category['hotel_desc']; ?></p>
                                                            <button class="btn btn-primary-inverse" id="<?php echo $all_category['hotel_name']; ?>">GET DETAILS</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="box-member-caption-inner">
                                                    <div class="box-member-caption-wrap">
                                                        ...
                                                        <div class="offset-top-20">
                                                            <p style="display: none" class="2"><?php echo $all_category['s_product_image']; ?></p>
                                                            <p style="display: none" class="3"><?php echo $all_category['hotel_name']; ?></p>
                                                            <p style="display: none" class="3"><?php echo $all_category['hotel_desc']; ?></p>
                                                            <button class="btn btn-primary-inverse" id="<?php echo $all_category['hotel_name']; ?>">GET DETAILS</button>
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="section-30">
                        <p><center>Hotel description</center></p>
                        <div class="text-gray-darker well">
                           <p id="select" style="color: black"></p>
                        </div>

                        <a href="contacts.php#3" class="btn btn-default" style="border-radius: 10px">Book Now</a>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        $("button").click(function(event) {
            ...
            for(var i = 0; i < inputt3.length; i++){
                ...
                if(get_name==get_id){
                    var link = get_cat;
                    document.getElementById("select").innerHTML = link;
                    $('#modal').modal({
                        show: 'true'
                    });
                }
