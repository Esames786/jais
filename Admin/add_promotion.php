...
<div id="wrapper">
    <div class="main-content">
        <form action="add_promotion.php" method="post" class="form-horizontal">
            <div class="form-row">
                <div class="container">
                    <div class="row col-md-10 custyle">
                        <table class="table table-striped custab" width="600" border="1" cellpadding="1"
                            ...
                            while ($employee = $result->fetch_array()) {
                                ...
                                $s=$employee['product_name'];
                                ?>
                                <td> <a href="add_promotion_script.php?id=<?php echo "$s" ?>" name="submit" class="btn btn-primary">Add to Promotion</a> </td>
                                </tr>
                                <?php
