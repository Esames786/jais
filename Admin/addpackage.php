...
<div id="wrapper">
    <div class="main-content">
        <form id="form" action="addpackage_script.php" method="post" enctype="multipart/form-data">
            <h1>ADD PACKAGE </h1>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="input_pname">Package Name</label>
                    <input type="text" class="form-control" id="ven_p_pname" placeholder="Package Name" name="ven_p_pname" required>
                </div>
                <div class="form-group col-md-6">
                    <label for="input_pdescription">Package Price</label>
                    <input type="text" class="form-control" id="ven_p_pdesc" placeholder="example : 1000" name="ven_p_pdesc" required>
                </div>
            </div>
            <div class="form-row">
                ...
                <div class="row">
                    <div class="form-group col-md-12 col-lg-offset-4">
                        ...
                        <a href="allpackage.php" class="btn btn-success btn-lg"><b>+</b> All
                            Packages</a>
                    </div>
