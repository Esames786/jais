...
<div id="wrapper">
    <div class="main-content">
        <form id="form" action="add_sub_product_script.php" method="post" enctype="multipart/form-data">
            <h1>ADD TOUR </h1>
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="input_pname">Product Name</label>
                    <input type="text" class="form-control" id="ven_p_pname" placeholder="Product Name" name="ven_p_pname" required>
                </div>
                <div class="form-group col-md-6">
                    <label for="input_pdescription">Description</label>
                    <input type="text" class="form-control" id="ven_p_pdesc" placeholder="Description" name="ven_p_pdesc" required>
                </div>
            </div>
            <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="input_image1">Product Image1</label>
                        <input id="uploadImage" type="file" accept="image/*" name="ven_p_ppic1" required/>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-12 col-lg-offset-4">
                        ...
                        <a href="all_sub_products.php" class="btn btn-success btn-lg"><b>+</b> All
                            Sub Products</a>
                    </div>
...
<script>
    ...
    $(document).ready(function (e) {
        $("#form").on('submit', (function (e) {
            e.preventDefault();
            $.ajax({
                url: "add_sub_product_script.php",
                type: "POST",
