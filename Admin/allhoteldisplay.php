...
if (isset($_POST['submit'])) {
    ...
    $sql4 = "SELECT * FROM hotel where hotel_name = '$ven_product1'";
    $result4 = $connect->query($sql4);


    $employee2 = $result4->fetch_array();
}
        ...
        <form id="form" action="all_visa_display_script.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input style="display: none" type="text" class="form-control" id="sub_product_id" placeholder="id" name="sub_product_id" value="<?php echo $employee2['id']; ?>" />
                    <input type="text" class="form-control" id="ven_p_pname" placeholder="Hotel Name" name="ven_p_pname" value="<?php echo $employee2['hotel_name']; ?>" required/>
                </div>
                <div class="form-group col-md-6">
                    <label for="input_pdescription">Hotel Description</label>
                    <textarea type="text" class="form-control" id="ven_p_pdesc" placeholder="example : xyz" name="ven_p_pdesc" required><?php echo $employee2['hotel_desc']; ?></textarea>
                </div>
            </div>
            <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <p  class="form-control" id="imgg2"><?php echo $employee2['s_product_image']; ?></p>
                    </div>
