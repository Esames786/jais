...
$sql = "SELECT DISTINCT (category_name)FROM package_details";
$result = $connect->query($sql);


$sql1 = "SELECT DISTINCT (s_product_name) FROM package_details";
...
<div id="wrapper">
    <div class="main-content">
        <form action="allpackage_details_view.php" method="post">
            <h1>All Package's Detail</h1>
