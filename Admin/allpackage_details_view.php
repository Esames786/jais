...
$sql = "SELECT * FROM package_details WHERE category_name ='$ven_product' and s_product_name = '$ven_product1'";
$result = $connect->query($sql);

$sql2 = "SELECT * FROM package_details WHERE category_name ='$ven_product' and s_product_name = '$ven_product1'";
            ...
            <div class="form-row">
                <div class="container">
                    <div class="row col-md-10 custyle">
                            ...
                            <br>
                                <div class="col-md-6 form-row" style="display: none">
...
<script>
    $(document).ready(function(){
        ...
        $('#insert_form').on('submit', function(event){
            ...
            {
                $.ajax({
                    url:"allpackage_details_view_script.php",
                    method:"POST",
                    data:form_data,
